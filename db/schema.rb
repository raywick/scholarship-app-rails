...
ActiveRecord::Schema.define(version: 2020_04_13_100605) do
  ...
  create_table "applications", force: :cascade do |t|
    ...
    t.integer "career_id", default: 1, null: false
    t.integer "scholarship_id", default: 1, null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.date "birthday"
    t.boolean "test_user_role", default: false
