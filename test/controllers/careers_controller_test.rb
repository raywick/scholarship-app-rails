...
class CareersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create career" do
    assert_difference('Career.count') do
      post careers_url, params: { career: { description: @career.description, name: @career.name } }
    end
  ...
  test "should update career" do
    patch career_url(@career), params: { career: { description: @career.description, name: @career.name } }
